...
#define __PYX_HAVE__pyIMU___fcore
#define __PYX_HAVE_API__pyIMU___fcore
/* Early includes */
#include <math.h>
#ifdef _OPENMP
#include <omp.h>
...
extern int __pyx_module_is_main_pyIMU___fcore;
int __pyx_module_is_main_pyIMU___fcore = 0;

/* Implementation of "pyIMU._fcore" */
...
static PyObject *__pyx_f_5pyIMU_6_fcore_integrate_quaternion_step(double __pyx_v_qw, double __pyx_v_qx, double __pyx_v_qy, double __pyx_v_qz, double __pyx_v_gx, double __pyx_v_gy, double __pyx_v_gz, double __pyx_v_bx, double __pyx_v_by, double __pyx_v_bz, double __pyx_v_fx, double __pyx_v_fy, double __pyx_v_fz, double __pyx_v_gain, double __pyx_v_dt, CYTHON_UNUSED int __pyx_skip_dispatch) {
  double __pyx_v_hgx;
  double __pyx_v_hgy;
  double __pyx_v_hgz;
  double __pyx_v_qdw;
...
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("integrate_quaternion_step (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  ...
  __pyx_r = __pyx_pf_5pyIMU_6_fcore_integrate_quaternion_step(__pyx_self, __pyx_v_qw, __pyx_v_qx, __pyx_v_qy, __pyx_v_qz, __pyx_v_gx, __pyx_v_gy, __pyx_v_gz, __pyx_v_bx, __pyx_v_by, __pyx_v_bz, __pyx_v_fx, __pyx_v_fy, __pyx_v_fz, __pyx_v_gain, __pyx_v_dt);
...
static PyObject *__pyx_pf_5pyIMU_6_fcore_integrate_quaternion_step(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_qw, double __pyx_v_qx, double __pyx_v_qy, double __pyx_v_qz, double __pyx_v_gx, double __pyx_v_gy, double __pyx_v_gz, double __pyx_v_bx, double __pyx_v_by, double __pyx_v_bz, double __pyx_v_fx, double __pyx_v_fy, double __pyx_v_fz, double __pyx_v_gain, double __pyx_v_dt) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
...
static int __pyx_pymod_exec__fcore(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec__fcore},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit__fcore(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit__fcore(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec__fcore(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module '_fcore' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "_fcore" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit__fcore", 0);
  ...
  if (__pyx_module_is_main_pyIMU___fcore) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "pyIMU._fcore")) {
      if (unlikely((PyDict_SetItemString(modules, "pyIMU._fcore", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init pyIMU._fcore", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init pyIMU._fcore");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
